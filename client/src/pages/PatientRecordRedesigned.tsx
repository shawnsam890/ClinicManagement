...
export default function PatientRecord() {
  ...
  const handleDeleteMedia = (fileId: string, visitId: number) => {
    // Confirm deletion
    ...
    // Delete the file
    apiRequest('DELETE', `/api/visits/${visitId}/media/${fileId}`)
      .then(() => {
        // Invalidate the visit query to refresh the media gallery
